...
public interface IStorage<T extends Storable> {
    /**
     * Add an item to this storage. Must call {@code store()} on the newly inserted item.
    ...
    /**
     * Remove an item from this storage. Must call {@code remove()} on the newly removed item.
     */
    void unload();
